...
public class Blood_And_Glucose_UpdateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        updatebtn.setOnClickListener(Blood_And_Glucose_UpdateActivity.this);
        progresbtn = (Button) findViewById(R.id.progresbtn);
        progresbtn.setOnClickListener(Blood_And_Glucose_UpdateActivity.this);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.updatebtn) {
            ...
            startActivity(new Intent(getApplicationContext(),Progress_Glucose_BP_Activity.class));
        }
    }
